<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SanPhamMeo.aspx.cs" Inherits="PetShop.web_pages.SanPhamMeo" %>
...
<body>
        ...
        <div class="navBar_Container">
            ...
            <nav class="header__navbar">
                <ul class="menu_list">
                    ...
                    <li><a href="SanPhamMeo.aspx" style="color:#FA8072;" >Mèo</a></li>
    ...
    <main>
        <div class="anhbia">
            <img src="../assest/images/meo.png" alt="hình ảnh" class="img_bia" style="width:100%"/>
        </div>

        <h1 class="title">Sản phẩm dành cho mèo</h1>
